...
describe("App", () => {
  ...
  it("shows grouped results with a fixed detail panel after the final vote", () => {
    ...
    expect(screen.queryByText("your result: 48%")).not.toBeInTheDocument()
    expect(screen.queryByText("all wrong: 0%")).not.toBeInTheDocument()
    expect(screen.queryByText("random chance: 50%")).not.toBeInTheDocument()
    expect(screen.queryByText("mean result: 62%")).not.toBeInTheDocument()
    expect(screen.queryByText("all correct: 100%")).not.toBeInTheDocument()
    expect(screen.queryAllByLabelText(/score marker/)).toHaveLength(0)
    ...
    expect(screen.getAllByLabelText(/Incorrect answer/).length).toBeGreaterThanOrEqual(26)
    expect(screen.getAllByLabelText(/Correct answer/).length).toBeGreaterThanOrEqual(24)
    ...
    expect(within(panel).getByLabelText("Incorrect answer")).toBeInTheDocument()
    ...
    expect(within(panel).getByLabelText("Correct answer")).toBeInTheDocument()
